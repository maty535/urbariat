---
layout: post
title: "VZ 25/07 Aký podiel na zisku za rok 2024 možem očakávať?"
date: 2025-11-19
...
- Na základe schválenia účtovnej uzávierky za rok 2024 valným zhromaždením podielnikov (pri **53.15 %** majetkovej účati na VZ z celkovej výmery urbáru na VZ 26.10.2025 a **54,34 %** majetkovej účasti zo známych členov spoločenstva)  a nárvhu výboru na rozdelenie zisku, kde v tomto roku navrhol výbor vyplatiť celý dosiahnutý zisk, t.z. celú sumu **20 139€**, bez tvorby akejkoľvek rezervy pre pestovateľskú činnosť, na ktorú sa použijú rezervy alokované v min. rokoch.
...
- {% alert caution %} Bez toho, aby sa valného zhromaždenia zúčastnili podielnici, alebo ich splnomocnení zástupcovia, ktorí disponujú vačšinou z výmery známych vlastníkov urbariátu by nemohla byť schválená účtovná uzávierka, ani návrh výboru na rozdelenie zisku pre podielnikov, t.z. pri neúčasťi podielnikov (alebo ich splnomocnených zástupcov) disponujúcich viac ako 50 % z výmery známych vlastníkov urbariátu, nemože dojsť ani k výplate akéhoľvek dosiahnutého zisku. Ten môže byť rozdelený a vyplatený až po valnom zhromaždení, ktoré má dostatočnú účasť podielnikov, resp. ich splnomocnených zástupcov. {% endalert %}
...
- **1 286 889 m2** - celková výmera urbáru
...
<!-- Results Display -->
<table>
  <tr><th>Pomer účasti</th><th>Ideálna plocha</th><th>Dividenda</th></tr>
...
* <a href="{{ '/about/' | relative_url }}#majetková-podstata">Majetková podstata</a>
